...
{{% alert title="Check out the calendar" color="info" %}}
You can also find the next events on the calendar at the bottom of the **[home
...
- **Manna Seoul** foodtruck comes on **the first Thursday** of the month. They
  ...
  [Manna Seoul's website][mannas].

- **Pizza Mondo** comes twice a month to Darwin Green, near the Community
  Rooms, on **the second and the fourth Thursdays**. They do, well, pizzas.
  Find more information and order from [Pizza Mondo's website][pmondo].

- **Pimp My Fish** comes **every third Thursday** of the month, to sell fish &
  chips, but also tacos, burgers, and more. You can find information and order
  online from [Pimp My Fish's website][pmp].
...
## LEGO Club, Board Games Club

LEGO and board games sessions for children aged 6-14 take place **weekly on
Saturdays, from 2 to 4 pm**, at the Community Rooms.

## Grown-ups Board Game Sessions

A board game session for adults take place **on the first Saturday of each
month, from 10 am to 5 pm**. All skills and abilities welcome. Feel free to
bring your own games, or just play what's there. Under-18s must be supervised.

Free tea and coffee are included, but a voluntary £5 cash contribution is
encouraged (for the whole day or part thereof, towards venue costs).

## Mobile Library

The mobile library truck comes near the Darwin Green Community Rooms **every
third Monday of the month**, **from 3 pm to 4:30 pm**. Find more information on
