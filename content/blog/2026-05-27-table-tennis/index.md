...
resources:
  - src: "**bats*.jpg"
    params:
      byline: >
        Table tennis rackets and ball on grass. Photo by Kateryna Artamonova
        from Pexels:
        https://www.pexels.com/photo/photo-of-table-tennis-rackets-on-grass-8681356/
  - src: "**table-tennis-play*.jpg"
    params:
      byline: >
        Residents getting a first taste of table tennis at Darwin Green Plaza.
summary: >
    Free drop-in table tennis sessions have launched in Darwin Green, every
    Saturday from 2 to 4 pm!
---

Darwin Green has a new community activity, and it's already up and running!

{{% imgproc table-tennis-play Resize "x600" %}}
...
![The poster for the activity](poster.jpg)
...
[previous-table-tennis]: {{< ref "/blog/2026-05-07-table-tennis" >}}
